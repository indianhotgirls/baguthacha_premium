...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('1871899094','6866849202').split()]
...
DB_URI = environ.get("DB_URI", "mongodb+srv://diouser007:LVbBUSKKuieS7Sgo@baguthacha.n8rhj.mongodb.net/?retryWrites=true&w=majority&appName=baguthacha")
DB_NAME = environ.get("DB_NAME", "baguthacha")
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "substantial-sofie-indianhotgirls-0f15beb6.koyeb.app/")
